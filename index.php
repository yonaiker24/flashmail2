...
<body>
    <header>
       <div class="container-fluid iniciarSesion">
        <div class="row">
           <div class="logo col-md-4">
             <img src="imagenes/logo.png" alt="" height="90">
            </div>
            <div class="col-md-8">
       ...
       <div class="container-fluid registro">
          ...
          <div class="row">
              <div class="col-md-6  offset-md-6">
                  <form  action="php/registroBD.php" onsubmit="return validar();" method ="POST">
                     <div class="row">
                         <div class="col-md-6">
                             <div class="form-group">
                                  <label class="form-label" for="nombres">Nombres:</label>
                                  <input type="text" class="form-control" id="nombres" name="nombres" placeholder="Nombres" tabindex="1" required>
                              </div>    
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="date" class="form-control" id="fechaNacimiento" name="fechaNacimiento" tabindex="3" required>
                              </div>   
                              <div class="form-group">
                                  <label class="form-label" for="contraseña">Contraseña:</label>
                                  <input type="password" class="form-control" id="contraseña" name="contraseña" placeholder="Ingrese su contraseña" tabindex="4" required>
                              </div>    
                              <div class="form-group">
                                  <label class="form-label" for="repiteContraseña">Repite tu contraseña:</label>
                                  <input type="password" class="form-control" id="repiteContraseña" name="repiteContraseña" placeholder="Repita su contraseña" tabindex="5" required>
                              </div> 
                         </div>
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                <label class="form-label" for="repiteContraseña">Selecciona tu país:</label>
                             ...
                             <div class="form-group">
                                  <label class="form-label" for="nombres">Estado:</label>
                                  <input type="text" class="form-control" id="estado" name="estado" placeholder="Estado" tabindex="7" required>
                              </div> 
                              <div class="form-group">
    ...
    <footer>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4">
                    <ul class="text-center logoFooter">
